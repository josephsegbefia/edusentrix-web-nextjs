...
export default function TeacherErrorUI({
  error,
  reset,
}: {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border border-rose-500/40 bg-gradient-to-br from-rose-500/15 to-transparent shadow-lg shadow-black/20 backdrop-blur">
        <CardHeader>
