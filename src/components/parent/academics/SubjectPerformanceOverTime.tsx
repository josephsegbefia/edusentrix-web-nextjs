// src/components/parent/academics/SubjectPerformanceOverTime.tsx
"use client";
        ...
        <CardContent>
          <div className="rounded-xl border border-dashed border-white/15 bg-black/30 px-4 py-8 text-center">
            <p className="text-[11px] text-muted-foreground/90">
              Historical data will appear after multiple terms
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <PremiumSelectTrigger className="h-8 min-w-[180px] rounded-full text-xs">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={chartData}>
                ...
                <ReferenceLine
                  ...
                  strokeDasharray="2 2"
                  label={{ value: "Pass (50%)", position: "insideTopRight", fill: "rgba(255,255,255,0.5)", fontSize: 10 }}
                />
                <Line
                  type="monotone"
                  dataKey="score"
