...
import { useStudentAcademicProfileBreakdown } from "@/hooks/student/useStudentAcademicProfile";
...
export function StudentAssessmentBreakdownModal({
  subjectId,
  periodId,
  open,
  onOpenChange,
        ...
        {isError ? (
          <div className="rounded-xl border border-destructive/50 bg-destructive/10 px-4 py-8 text-center">
            ...
            <p className="mt-2 text-xs text-white/50">
              Subject details appear after your school publishes your official report
              card.
            </p>
          </div>
        ) : null}
