// src/components/modals/RejectPollModal.tsx
"use client";
...
import { useRejectPoll } from "@/hooks/admin/useCommunityPolls";
import { useBusyToast } from "@/hooks/useBusyToast";
import { toast } from "sonner";

interface RejectPollModalProps {
...
export default function RejectPollModal({
  open,
  onOpenChange,
  pollId,
  pollTitle,
  onSuccess,
}: RejectPollModalProps) {
  const rejectMutation = useRejectPoll();
  ...
  const handleReject = async () => {
    ...
    busyToast.show("Rejecting poll...");

    try {
      await rejectMutation.mutateAsync({ pollId, reason: reason.trim() });
