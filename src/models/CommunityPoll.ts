...
export interface ICommunityPoll {
  ...
  // Template reference (null = custom poll)
  ...
  minResponseRate: number; // Minimum % of eligible respondents required for valid results
...
const CommunityPollSchema = new Schema<ICommunityPoll>(
  {
    ...
    // Template reference (null = custom poll)
    templateId: { type: Schema.Types.ObjectId, ref: "PollTemplate", default: null },
