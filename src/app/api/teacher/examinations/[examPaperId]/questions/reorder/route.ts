...
import { reorderQuestionsAction } from "@/lib/examinations/builder-route-actions";
...
export async function POST(
  ...
  try {
    ...
    return Response.json(
      { success: false, error: error instanceof Error ? error.message : "Failed to reorder questions" },
      { status: 500 }
    );
  }
}
