...
export const PERMISSIONS = {
  ...
  examsReview: "exams.review",
  examsApprove: "exams.approve",
  examsPrint: "exams.print",
  examsComplete: "exams.complete",
  examsArchive: "exams.archive",
  examQuestionsCreate: "examQuestions.create",
  examQuestionsUpdate: "examQuestions.update",
  examQuestionsDelete: "examQuestions.delete",
  examQuestionsAttachmentsManage: "examQuestions.attachments.manage",
  questionBankRead: "questionBank.read",
  questionBankCreate: "questionBank.create",
  questionBankUpdate: "questionBank.update",
  questionBankCurate: "questionBank.curate",
  questionBankArchive: "questionBank.archive",
  questionBankReuse: "questionBank.reuse",
  examTypesManage: "examTypes.manage",
  examSettingsManage: "examSettings.manage",
  examAiUse: "examAi.use",
  examAnalyticsView: "examAnalytics.view",
} as const;
...
const BASE_ROLE_PERMISSIONS: Record<MembershipRole, Permission[]> = {
  teacher: [
    ...
    PERMISSIONS.examsUpdate,
    PERMISSIONS.examsSubmit,
    PERMISSIONS.examsPrint,
    PERMISSIONS.examsComplete,
    PERMISSIONS.examQuestionsCreate,
    PERMISSIONS.examQuestionsUpdate,
    PERMISSIONS.examQuestionsDelete,
    PERMISSIONS.examQuestionsAttachmentsManage,
    PERMISSIONS.questionBankRead,
    PERMISSIONS.questionBankCreate,
    PERMISSIONS.questionBankUpdate,
    PERMISSIONS.questionBankReuse,
    PERMISSIONS.examAiUse,
  ],
...
const SUBROLE_PERMISSIONS: Record<TeacherSubrole, Permission[]> = {
  ...
  exam_officer: [
    ...
    PERMISSIONS.examsUpdate,
    PERMISSIONS.examsSubmit,
    PERMISSIONS.examsReview,
    PERMISSIONS.examsApprove,
    PERMISSIONS.examsPrint,
    PERMISSIONS.examsComplete,
    PERMISSIONS.questionBankRead,
    PERMISSIONS.questionBankCurate,
    PERMISSIONS.examAnalyticsView,
  ],
  department_lead: [
    PERMISSIONS.analyticsView,
    PERMISSIONS.assignmentsPublish,
