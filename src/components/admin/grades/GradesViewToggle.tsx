...
export type GradesViewMode = "cards" | "table";

type GradesViewToggleProps = {
  value: GradesViewMode;
  onChange: (mode: GradesViewMode) => void;
};

export function GradesViewToggle({
  value,
  onChange,
}: GradesViewToggleProps) {
