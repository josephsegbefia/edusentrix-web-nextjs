...
export const CreateProposalSchema = z.object({
  ...
  source: z.enum(["manual", "school_record", "lead", "demo_visit", "application"]).default("manual"),
  ...
  proposalType: z.enum(["general", "pilot", "full_implementation", "pricing", "demo_follow_up"]).default("full_implementation"),
