...
> = {
  ...
  "platform.schools.assistedAccess": {
    key: "platform.schools.assistedAccess",
    label: "Assist As School Admin",
    description: "Start time-bound assisted school-admin access for a school. All actions must be audited.",
    category: "Schools",
    riskLevel: "critical",
    assignable: true,
  },
  "platform.schools.assistedAccess.delegated": {
    key: "platform.schools.assistedAccess.delegated",
    label: "Delegated Assisted Access",
    description: "Start assisted school-admin access only for schools explicitly delegated to the staff member.",
    category: "Schools",
    riskLevel: "critical",
    assignable: true,
  },
  ...
  "platform.proposals.read": {
    key: "platform.proposals.read",
    label: "View Proposals",
    description: "View proposal center records, proposal details, activity, and send history.",
    category: "Growth",
    riskLevel: "low",
    assignable: true,
  },
  "platform.proposals.create": {
    key: "platform.proposals.create",
    label: "Create Proposals",
    description: "Create school acquisition proposals from approved templates.",
    category: "Growth",
    riskLevel: "medium",
    assignable: true,
  },
  "platform.proposals.update": {
    key: "platform.proposals.update",
    label: "Update Proposals",
    description: "Edit proposal content, pricing, recipient details, and ownership.",
    category: "Growth",
    riskLevel: "medium",
    assignable: true,
  },
  "platform.proposals.archive": {
    key: "platform.proposals.archive",
    label: "Archive Proposals",
    description: "Archive proposals that should no longer be active.",
    category: "Growth",
    riskLevel: "medium",
    assignable: true,
  },
  "platform.proposals.generatePdf": {
    key: "platform.proposals.generatePdf",
    label: "Generate Proposal PDFs",
    description: "Generate downloadable proposal PDFs from proposal content.",
    category: "Growth",
    riskLevel: "medium",
    assignable: true,
  },
  "platform.proposals.send": {
    key: "platform.proposals.send",
    label: "Send Proposals",
    description: "Email proposals to schools and record send logs.",
    category: "Growth",
    riskLevel: "high",
    assignable: true,
  },
  "platform.proposals.manageTemplates": {
    key: "platform.proposals.manageTemplates",
    label: "Manage Proposal Templates",
    description: "Create, update, duplicate, and archive proposal templates.",
    category: "Growth",
    riskLevel: "high",
    assignable: true,
  },
  "platform.proposals.manageBranding": {
    key: "platform.proposals.manageBranding",
    label: "Manage Proposal Branding",
    description: "Update proposal letterhead, colors, contact details, and branding defaults.",
    category: "Growth",
    riskLevel: "high",
    assignable: true,
  },
  "platform.proposals.manageFollowUps": {
    key: "platform.proposals.manageFollowUps",
    label: "Manage Proposal Follow-ups",
